...
import { User, Mail, Lock, Loader, ArrowRight, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-midnight-950 bg-grid-pattern bg-[size:32px_32px] flex items-center justify-center px-4 py-10 sm:py-16">
      <div className="w-full max-w-[26rem] animate-fade-up">
        ...
        <div className="text-center mb-8">
          <h1 className="font-display text-2xl sm:text-3xl text-white font-semibold">Create your account</h1>
          <p className="text-white/50 mt-2 text-sm sm:text-base">Turn your bookings into a real itinerary</p>
        </div>
